...
@scenario('../features/integration_test_device_create_flow.feature', 'Integration E2E test for device C100 creates a sender flow')
def test_c100_e2e_creates_a_flow():
     pass
